    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/wsproject/public/user" aria-label="{{ __('Register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <pre><textarea class="form-control" name="hobby" required=""></textarea></pre>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <pre><textarea class="form-control" name="objective" rows="4" required=""></textarea></pre>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <pre><textarea class="form-control" name="quote" required=""></textarea></pre>
